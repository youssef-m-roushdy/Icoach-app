      ...
      if (result?.success) {
        ...
        if (
          ...
          showInfoToast({
            ...
            message: t('noWorkoutsMatchFilters'),
          });
        }
      } else {
        showErrorToast({
    ...
    try {
      if (!token) {
        showErrorToast({
          ...
          message: t('needLoginToSaveWorkouts'),
        });
        return;
      }
      ...
      showSuccessToast({
        title: t('workoutSavedTitle'),
        message: t('workoutSavedMessage').replace('{name}', workout.name),
      });
    } catch (error: unknown) {
      ...
      showErrorToast({
        ...
        message: getErrorMessage(error) || t('saveFailedMessage'),
      });
    }
  };
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 16, paddingBottom: 8 }}>
          <View style={styles.filterRow}>
            ...
            >
              ...
              >
                {selectedTargetArea || t('targetAreaFilterLabel')}
              </Text>
              <Ionicons
                name="chevron-down"
                size={16}
            ...
            >
              ...
              >
                {selectedEquipment || t('equipmentFilterLabel')}
              </Text>
              <Ionicons
                name="chevron-down"
                size={16}
