...
app.MapGet("/rate-limit-status", (HttpContext ctx) =>
{
    ...
    return Results.Ok(new
    {
        ...
        policies = new[]
        {
            ...
            new { route = "/api/v1/conversations/**",             limit = 60,  window = "1m",  type = "sliding" },
            new { route = "/api/v1/chat-participants/**",         limit = 60,  window = "1m",  type = "sliding" },
            new { route = "/api/v1/notifications/**",             limit = 50,  window = "15m", type = "sliding" },
            ...
            new { route = "/api/v1/injuries/**",                  limit = 100, window = "15m", type = "sliding (global)" },
            new { route = "/api/v1/user-injuries/**",             limit = 100, window = "15m", type = "sliding (global)" },
            new { route = "/api/v1/workout-injuries/**",          limit = 100, window = "15m", type = "sliding (global)" },
            new { route = "/api/v1/allergens/**",                 limit = 100, window = "15m", type = "sliding (global)" },
            new { route = "/api/v1/user-allergies/**",            limit = 100, window = "15m", type = "sliding (global)" },
            new { route = "/api/v1/food-allergens/**",            limit = 100, window = "15m", type = "sliding (global)" },
            new { route = "/api/v1/personal-bests/**",            limit = 100, window = "15m", type = "sliding (global)" }
        }
    });
});
...
app.MapGet("/debug/routes", () => Results.Ok(new
{
    ...
    apiEndpoints = new[]
    {
        ...
        new { path = "/api/v1/conversations/**", method = "ALL", description = "Conversations management" },
        new { path = "/api/v1/chat-participants/**", method = "ALL", description = "Chat participants management" },
        new { path = "/api/v1/presence", method = "GET", description = "User presence" },
        new { path = "/api/v1/notifications/**", method = "ALL", description = "Push notifications management" },
        new { path = "/api/v1/personal-bests/**", method = "GET", description = "Personal bests tracking" },
        new { path = "/api/v1/injuries/**", method = "ALL", description = "Injuries management" },
        new { path = "/api/v1/user-injuries/**", method = "ALL", description = "User injuries tracking" },
        new { path = "/api/v1/workout-injuries/**", method = "ALL", description = "Workout-injury relationships" },
        new { path = "/api/v1/allergens/**", method = "ALL", description = "Allergens database" },
        new { path = "/api/v1/user-allergies/**", method = "ALL", description = "User allergies tracking" },
        new { path = "/api/v1/food-allergens/**", method = "ALL", description = "Food-allergen relationships" },
